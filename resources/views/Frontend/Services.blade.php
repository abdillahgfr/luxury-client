      ...
      <div class="row gy-4 gx-4">
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="destination-item th-ani">
            ...
            <div class="destination-content">
              <h3 class="box-title">
                <a href="contact.html">Photo Shoot</a>
              </h3>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="destination-item th-ani">
            ...
            <div class="destination-content">
              <h3 class="box-title">
                <a href="contact.html">Interesting Rest</a>
              </h3>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="destination-item th-ani">
            ...
            <div class="destination-content">
              <h3 class="box-title">
                <a href="contact.html">Safe Flight</a>
              </h3>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="destination-item th-ani">
            ...
            <div class="destination-content">
              <h3 class="box-title">
                <a href="contact.html">Entertainment</a>
              </h3>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
          <div class="destination-item th-ani">
            ...
            <div class="destination-content">
              <h3 class="box-title">
                <a href="contact.html">Delicisious Food</a>
              </h3>
      ...
      <div class="row gy-4 justify-content-center">
          ...
          <div class="price-card">
            ...
            <div class="price-card_content">
              <h4 class="price-card_price">
                $785.00<span class="duration">/Per Night</span>
              </h4>
            ...
            <div class="price-btn">
              <a href="contact.html" class="th-btn style3 w-100"
                >Get Started</a
              >
            </div>
          </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="price-card active">
            ...
            <div class="price-card_content">
              <h4 class="price-card_price">
                $980.00<span class="duration">/Per Night</span>
              </h4>
              <p class="price-card_text">
                Essential services for basic and signle person seeking.
              </p>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="price-card">
            ...
            <div class="price-card_content">
              <h4 class="price-card_price">
                $1580.00<span class="duration">/Per Night</span>
              </h4>
              <p class="price-card_text">
                Essential services for basic and signle person seeking.
              </p>
