...
<div class="hero-3" id="hero">
      ...
      <div class="swiper-wrapper">
            ...
            <div class="container">
              <div class="hero-style3">
                ...
                <div
                  ...
                  data-ani-delay="0.6s"
                >
                  <a href="destination.html" class="th-btn style2 th-icon"
                    >Explore Tours</a
                  >
                </div>
              </div>
        ...
        <div class="swiper-slide">
          <div class="hero-inner">
            <div
              class="th-hero-bg"
              data-bg-src="assets/img/hero/hero_bg_3_4.jpg"
            ></div>
            <div class="container">
              <div class="hero-style3">
                <h1
        ...
        <div class="swiper-slide">
          <div class="hero-inner">
            <video autoplay loop muted>
              <source
                src="assets/img/hero/hero-video3.mp4"
                type="video/mp4"
              />
            </video>
            <div class="container">
    ...
    <div class="hero3-wrapper">
      <div class="container">
        <div
          class="row justify-content-center align-items-end flex-row-reverse"
        >
          <div class="col-lg-4">
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-5">
          <h2 class="destination-title">
            <span class="counter-number">850</span>+ Destinations
          </h2>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="destination-item th-ani">
                <div class="destination-item_img global-img">
                  <img
                    src="assets/img/destination/destination_3_1.jpg"
                    alt="image"
                  />
                </div>
                <div class="destination-content">
                  <h3 class="box-title">
                    <a href="destination-details.html">Dubai, UAE</a>
                  </h3>
            ...
            <div class="swiper-slide">
              <div class="destination-item th-ani">
                <div class="destination-item_img global-img">
                  <img
                    src="assets/img/destination/destination_3_2.jpg"
                    alt="image"
                  />
                </div>
                <div class="destination-content">
                  <h3 class="box-title">
                    <a href="destination-details.html">Japan</a>
                  </h3>
                  <p class="destination-text">25 Listing</p>
                  <a
                    href="destination-details.html"
            ...
            <div class="swiper-slide">
              <div class="destination-item th-ani">
                <div class="destination-item_img global-img">
                  <img
                    src="assets/img/destination/destination_3_3.jpg"
                    alt="image"
                  />
                </div>
                <div class="destination-content">
            ...
            <div class="swiper-slide">
              <div class="destination-item th-ani">
                <div class="destination-item_img global-img">
                  <img
                    src="assets/img/destination/destination_3_4.jpg"
                    alt="image"
                  />
                </div>
                <div class="destination-content">
  ...
  <section class="category-area3 bg-smoke space" data-bg-src="assets/img/bg/line-pattern3.png">
    <div class="container th-container">
      ...
      <div class="slider-area">
        <div
          class="swiper th-slider has-shadow category-slider3"
          id="categorySlider3"
  ...
  <div class="about-area position-relative overflow-hidden space" id="about-sec">
    ...
    <div
      class="shape-mockup movixgX d-none d-xxl-block"
      data-bottom="18%"
      data-right="2%"
    >
    ...
    <div
      class="shape-mockup movingCar d-none d-xxl-block"
      data-bottom="0%"
      data-right="2%"
    >
                      ...
                      <div class="tour-rating">
                        ...
                        >
                          <span style="width: 100%"
                            ...
                            5 based on <span class="rating">4.8</span>(4.8
                            Rating)</span
                          >
                        </div>
                        <a
                ...
                <div class="swiper-slide">
                  <div class="tour-box th-ani gsap-cursor">
                    ...
                    <div class="tour-content">
                      ...
                      <h4 class="tour-box_price">
                        <span class="currency">$970.00</span>/Person
                      </h4>
                      <div class="tour-action">
                        <span><i class="fa-light fa-clock"></i>7 Days</span>
                        <a
                ...
                <div class="swiper-slide">
                  <div class="tour-box th-ani gsap-cursor">
                    ...
                    <div class="tour-content">
                      ...
                      <h4 class="tour-box_price">
                        <span class="currency">$960.00</span>/Person
                      </h4>
                      <div class="tour-action">
                        <span><i class="fa-light fa-clock"></i>7 Days</span>
                        <a
                ...
                <div class="swiper-slide">
                  <div class="tour-box th-ani gsap-cursor">
                    ...
                    <div class="tour-content">
                      ...
                      <h4 class="tour-box_price">
                        <span class="currency">$940.00</span>/Person
                      </h4>
                      <div class="tour-action">
                        <span><i class="fa-light fa-clock"></i>7 Days</span>
                        <a
                ...
                <div class="swiper-slide">
                  <div class="tour-box th-ani gsap-cursor">
                    ...
                    <div class="tour-content">
                      ...
                      <h4 class="tour-box_price">
                        <span class="currency">$990.00</span>/Person
                      </h4>
                      <div class="tour-action">
                        <span><i class="fa-light fa-clock"></i>7 Days</span>
                        <a
                ...
                <div class="swiper-slide">
                  <div class="tour-box th-ani gsap-cursor">
                    ...
                    <div class="tour-content">
                      ...
                      <h4 class="tour-box_price">
                        <span class="currency">$950.00</span>/Person
                      </h4>
                      <div class="tour-action">
                        <span><i class="fa-light fa-clock"></i>7 Days</span>
                        <a
                ...
                <div class="swiper-slide">
                  <div class="tour-box th-ani gsap-cursor">
                    ...
                    <div class="tour-content">
                      <h3 class="box-title">
                        <a href="tour-details.html"
                          >Travel by Air Flight Package</a
                        >
                      </h3>
                      <div class="tour-rating">
                        <div
  ...
  <section class="team-area3 position-relative bg-top-center space" data-bg-src="assets/img/bg/team_bg_2.jpg">
    <div class="container z-index-common">
      ...
      <div class="slider-area">
        <div
          class="swiper th-slider teamSlider3 has-shadow"
          id="teamSlider3"
  ...
  <section class="testi-area3 bg-bottom-center overflow-hidden space" id="testi-sec" data-bg-src="assets/img/bg/map.png">
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-12">
          <div
            class="swiper th-slider testiSlide3"
            id="testiSlide3"
            ...
            <div class="swiper-wrapper">
                ...
                <div class="testi-grid">
                  ...
                  <div class="testi-grid_content">
                    <p class="testi-grid_text">
                      ...
                      until discovered Ecoland Residence. The moment I stepped
                ...
                <div class="testi-grid">
                  ...
                  <div class="testi-grid_content">
                    <p class="testi-grid_text">
                      ...
                      light to flood the interiors It incorporates passive
                      design principles”
                    </p>
              ...
              <div class="swiper-slide">
                <div class="testi-grid">
                  <div class="testi-grid_author">
                    <img
                      src="assets/img/testimonial/testi_3_3.png"
                      alt="Avater"
                    />
                  </div>
                  <div class="testi-grid_content">
              ...
              <div class="swiper-slide">
                <div class="testi-grid">
                  <div class="testi-grid_author">
                    <img
                      src="assets/img/testimonial/testi_3_4.png"
                      alt="Avater"
                    />
                  </div>
                  <div class="testi-grid_content">
              ...
              <div class="swiper-slide">
                <div class="testi-grid">
                  <div class="testi-grid_author">
                    <img
                      src="assets/img/testimonial/testi_3_5.png"
                      alt="Avater"
                    />
                  </div>
                  <div class="testi-grid_content">
              ...
              <div class="swiper-slide">
                <div class="testi-grid">
                  <div class="testi-grid_author">
                    <img
                      src="assets/img/testimonial/testi_3_6.png"
                      alt="Avater"
                    />
                  </div>
                  <div class="testi-grid_content">
    ...
    <div
      class="swiper th-slider testi-grid-thumb"
        ...
        <div class="col-xl-7">
          <div class="blog-grid style2 th-ani">
            ...
            <div class="blog-grid_content">
              ...
              <h3 class="box-title">
                <a href="blog-details.html"
                  >The best time to visit japan & enjoy the cherry blossoms</a
                >
              </h3>
              <a href="blog-details.html" class="th-btn style4 th-icon"
                >Read More</a
