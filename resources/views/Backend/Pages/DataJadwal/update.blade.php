        ...
        <div class="content-wrapper">
            <div class="card">
                <div class="card-header">
                    <h4>Data Update Jadwal</h4>
                </div>
                <form action="{{ route('adminEditDataJadwal', $dataJadwal->id) }}" method="POST"
                                ...
                                <div class="mb-3">
                                    <div class="col-md-4">
                                        <div class="card mb-3">
                                            ...
                                            <div class="card-body">
                                                <p class="card-text">Foto Jadwal Saat ini</p>

                                                <hr>
                                                <label for="basicInput" class="form-label">Ganti Foto Jadwal</label>
                                                <input type="file"
