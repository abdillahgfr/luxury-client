    ...
    <div class="main-content">
        ...
        <div class="content-wrapper">
            <div class="card">
                ...
                <form action="{{ route('adminAddDataMateri') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                         ...
                         <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kategori') is-invalid @enderror"
                                        id="basicInput" placeholder="Masukan Kategori Materi" name="kategori"
                                        value="{{ old('kategori') }}">
                                    @error('kategori')
                                        <div class="alert alert-danger" role="alert" id="flashmessage">{{ $message }}
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="basicInput" class="form-label">Foto Materi</label>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="pilihan_materi" class="ckeditor" id="ckeditor">{{old('pilihan_materi')}}</textarea>
